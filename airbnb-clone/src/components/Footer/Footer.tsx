...
export default function Footer() {
  return (
    <div className="border-top mt-5 pt-5 bg-gray-100">
      <div className="container mx-auto gap-x-3 gap-y-8 px-10 pb-10 mb-5">
        <div className="row">
          <div className="col-6 col-sm-4 col-md-3">
            ...
            <div className="d-flex flex-column gap-2">
              <a
                ...
                aria-current="page"
                className="nav-link hover-underline active"
                href="/"
              >
      ...
      <div className="bg-gray-50 border-top fixed-bottom w-100 z-10  py-3 hidden d-m-block">
        <div className="container mx-auto px-10 d-flex justify-content-between align-items-center text-gray-500 ">
          <div>
