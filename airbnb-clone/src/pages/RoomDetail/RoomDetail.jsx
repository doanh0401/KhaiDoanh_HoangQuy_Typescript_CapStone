          ...
          <p>
            <button class="mr-3">
              <svg
                ...
                role="img"
                focusable="false"
                style="display: inline-block; height: 24px; width: 24px; fill: currentcolor;"
              >
            ...
            <span class="font-semibold text-xl sm:text-3xl tracking-widest leading-relaxed text-gray-900">
              Phòng Siêu Vip
            </span>
          </p>
          <div class="flex flex-wrap justify-between items-center">
            <div>
              <span class="text-sm font-normal tracking-widest">
                <i class="fa fa-star"></i> 1 .
              </span>{" "}
              <span class="underline text-sm font-normal tracking-widest mx-1">
                54 đánh giá
              </span>
              .
              <span class="text-sm font-normal tracking-widest mx-1">
                {" "}
                <i class="fa-solid fa-award"></i> Chủ nhà siêu cấp .
              </span>
              <span class="underline text-sm font-normal tracking-widest mx-1">
                , ,{" "}
              </span>
            ...
            <div class="flex flex-wrap justify-center items-center">
              <button class="px-2 py-1 hover:bg-gray-100 rounded-md transition-all duration-150 flex justify-center items-center font-semibold text-sm text-gray-700">
                <svg
                  viewBox="0 0 32 32"
                  xmlns="http://www.w3.org/2000/svg"
                  aria-hidden="true"
                  role="presentation"
                  focusable="false"
                  style="display: inline-block; fill: none; height: 16px; width: 16px; stroke: currentcolor; stroke-width: 2; overflow: visible;"
                >
                  <g fill="none">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-5">
          <div className="rounded-l-xl rounded-r-xl sm:rounded-r-none overflow-hidden">
            <img
              ...
              src="https://airbnb.cybersoft.edu.vn/public/images/room/1660811984769_images.jpg"
            />
          </div>
                  ...
                  <div className="flex flex-col border border-solid border-gray-400 rounded-md">
                    <div className="flex w-full border-b border-solid border-gray-400">
                      <div className="border-r border-solid border-gray-400 rounded-tl-md w-full p-2 cursor-pointer hover:bg-gray-100">
                        ...
                        <div className="m-1">12-11-2023</div>
                      </div>
        ...
        <div className="mt-10 pb-5 border-b">
          <div>
            <h2 className="font-semibold text-gray-800 text-xl pb-4 flex items-center">
              ...
              <div className="ml-2">51 đánh giá</div>
            </h2>
          </div>
